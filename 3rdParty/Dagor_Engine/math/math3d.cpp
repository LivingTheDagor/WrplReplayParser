...
const float realQNaN = std::bit_cast<float>(QNaNint);
const float realSNaN = std::bit_cast<float>(SNaNint);
const double doubleQNaN = std::bit_cast<double>(QNaNint64);
const double doubleSNaN = std::bit_cast<double>(SNaNint64);
