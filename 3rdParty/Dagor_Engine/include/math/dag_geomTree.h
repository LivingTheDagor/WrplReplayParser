...
public:
  ...
  void setNodeTmScalar(Index16 ni, const TMatrix &m)
  {
    ...
    G_ASSERTF(is_valid_pos(n_tm.col3), "setNodeTmScalar: invalid col3 {{{} {} {}}}", V3D(n_tm.col3));
  }
  ...
  void getNodeWtmScalar(Index16 ni, TMatrix &out_wtm) const
  {
    mat44f n_wtm;
    getNodeWtm(ni, n_wtm);
    v_mat_43cu_from_mat44(out_wtm.array.data(), n_wtm);
  }
  ...
  void setNodeWtm(Index16 ni, const mat44f &m)
  {
    ...
    G_ASSERTF(is_valid_pos(n_wtm.col3), "setNodeWtm: invalid col3 {{{} {} {}}}", V3D(n_wtm.col3));
  }
  void setNodeWtmScalar(Index16 ni, const TMatrix &m)
  {
    mat44f n_tm;
    v_mat44_make_from_43cu(n_tm, m.array.data());
    setNodeWtm(ni, n_tm);
  }
  ...
  static void mat44f_to_TMatrix(const mat44f &m, TMatrix &out_m) { v_mat_43cu_from_mat44(out_m.array.data(), m); }
  static void TMatrix_to_mat44f(const TMatrix &m, mat44f &out_m) { v_mat44_make_from_43cu(out_m, m.array.data()); }
