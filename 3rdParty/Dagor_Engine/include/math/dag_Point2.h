...
__forceinline Point2 abs(const Point2 &a) { return {fabsf(a.x), fabsf(a.y)}; }
__forceinline Point2 sqrt(const Point2 &a) { return {sqrtf(a.x), sqrtf(a.y)}; }
#undef max
#undef min
__forceinline Point2 max(const Point2 &a, const Point2 &b) { return {max(a.x, b.x), max(a.y, b.y)}; }
__forceinline Point2 min(const Point2 &a, const Point2 &b) { return {min(a.x, b.x), min(a.y, b.y)}; }
template <>
