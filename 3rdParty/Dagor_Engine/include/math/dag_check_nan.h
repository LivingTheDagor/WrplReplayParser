...
#else
DAG_FINITE_MATH inline bool check_nan(float a) { return __builtin_isnan(a); }
 DAG_FINITE_MATH inline bool check_nan(double a) { return __builtin_isnan(a); }
#endif
DAG_FINITE_MATH inline bool check_finite(float a) { return __builtin_isfinite(a); }
DAG_FINITE_MATH inline bool check_finite(double a) { return __builtin_isfinite(a); }
