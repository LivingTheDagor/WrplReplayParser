...
void include_types_5(py::module &gen) {
  ...
  py::class_<danet::ReflectionVar<std::array<std::string,2>>::SpaceHandler::TimeState>(gen, "std_array_std_string_2__ts")
  ...
  bind_readonly_vector<dag::Vector<danet::ReflectionVar<danet::dummyForDeathInfo>::SpaceHandler::TimeState>>(gen, "danet_dummyForDeathInfo_ts_vector");
  ...
  bind_readonly_vector<dag::Vector<danet::ReflectionVar<danet::DamagedState>::SpaceHandler::TimeState>>(gen, "danet_DamagedState_ts_vector");
  ...
  py::class_<danet::ReflectionVar<std::vector<danet::DamagedState>>::SpaceHandler::TimeState>(gen, "std_vector_danet_DamagedState__ts")
  ...
  bind_readonly_vector<dag::Vector<danet::ReflectionVar<danet::WeaponsMask>::SpaceHandler::TimeState>>(gen, "danet_WeaponsMask_ts_vector");
