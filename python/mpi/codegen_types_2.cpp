...
void include_types_2(py::module &gen) {
  ...
  bind_readonly_vector<dag::Vector<danet::ReflectionVar<std::vector<danet::WeatherEffect>>::SpaceHandler::TimeState>>(gen, "std_vector_danet_WeatherEffect__ts_vector");
  ...
  bind_readonly_vector<dag::Vector<danet::ReflectionVar<danet::UnitId>::SpaceHandler::TimeState>>(gen, "danet_UnitId_ts_vector");
  ...
  bind_readonly_vector<dag::Vector<danet::ReflectionVar<danet::Uid>::SpaceHandler::TimeState>>(gen, "danet_Uid_ts_vector");
  ...
  bind_readonly_vector<dag::Vector<danet::ReflectionVar<DataBlock>::SpaceHandler::TimeState>>(gen, "DataBlock_ts_vector");
  ...
  bind_readonly_vector<dag::Vector<danet::ReflectionVar<danet::Country>::SpaceHandler::TimeState>>(gen, "danet_Country_ts_vector");
  ...
  .def_property_readonly("history", [](danet::ReflectionVar<danet::Country> &self){return &self.get_history();}, py::return_value_policy::reference_internal);
  ...
  bind_readonly_vector<dag::Vector<danet::ReflectionVar<std::array<ecs::EntityId,20>>::SpaceHandler::TimeState>>(gen, "std_array_ecs_EntityId_20__ts_vector");
