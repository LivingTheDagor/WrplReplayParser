...
void include_types_1(py::module &gen) {
  ...
  bind_readonly_vector<dag::Vector<danet::ReflectionVar<danet::streak>::SpaceHandler::TimeState>>(
    gen, "danet_streak_ts_vector");
  ...
  bind_readonly_vector<dag::Vector<danet::ReflectionVar<std::vector<danet::streak>>::SpaceHandler::TimeState>>(
    gen, "std_vector_danet_streak__ts_vector");
  ...
  .def_readonly("time_ms", &danet::ReflectionVar<std::array<float,3>>::SpaceHandler::TimeState::time_ms)
    .def_readonly("value", &danet::ReflectionVar<std::array<float, 3>>::SpaceHandler::TimeState::data);

  bind_readonly_vector<dag::Vector<danet::ReflectionVar<std::array<float, 3>>::SpaceHandler::TimeState>>(
    gen, "std_array_float_3__ts_vector");
  ...
  .def_property_readonly("history", [](danet::ReflectionVar<std::array<float,3>> &self){return &self.get_history();}, py::return_value_policy::reference_internal);
  ...
  bind_readonly_vector<dag::Vector<danet::ReflectionVar<danet::zigZagPair>::SpaceHandler::TimeState>>(
    gen, "danet_zigZagPair_ts_vector");
  ...
  bind_readonly_vector<dag::Vector<danet::ReflectionVar<std::vector<danet::zigZagPair>>::SpaceHandler::TimeState>>(
    gen, "std_vector_danet_zigZagPair__ts_vector");
  ...
  bind_readonly_vector<dag::Vector<danet::ReflectionVar<std::string>::SpaceHandler::TimeState>>(gen,
                                                                                                "std_string_ts_vector");

  py::class_<danet::ReflectionVar<std::string>>(gen, "std_string_var")
  .def_readonly("data", &danet::ReflectionVar<std::string>::data)
    .def_property_readonly(
      "history", [](danet::ReflectionVar<std::string> &self) { return &self.get_history(); },
