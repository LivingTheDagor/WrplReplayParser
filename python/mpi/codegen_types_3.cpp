...
void include_types_3(py::module &gen) {
  ...
  .def_readonly("value", &danet::ReflectionVar<float>::SpaceHandler::TimeState::data);

  bind_readonly_vector<dag::Vector<danet::ReflectionVar<float>::SpaceHandler::TimeState>>(gen, "float_ts_vector");

  py::class_<danet::ReflectionVar<float>>(gen, "float_var")
  .def_readonly("data", &danet::ReflectionVar<float>::data)
  .def_property_readonly("history", [](danet::ReflectionVar<float> &self){return &self.get_history();}, py::return_value_policy::reference_internal);
  ...
  bind_readonly_vector<dag::Vector<danet::ReflectionVar<std::vector<uint8_t>>::SpaceHandler::TimeState>>(gen, "std_vector_uint8_t__ts_vector");
  ...
  bind_readonly_vector<dag::Vector<danet::ReflectionVar<std::vector<uint16_t>>::SpaceHandler::TimeState>>(gen, "std_vector_uint16_t__ts_vector");
  ...
  bind_readonly_vector<dag::Vector<danet::ReflectionVar<danet::dummyForKillStreaksProgress>::SpaceHandler::TimeState>>(gen, "danet_dummyForKillStreaksProgress_ts_vector");
  ...
  bind_readonly_vector<dag::Vector<danet::ReflectionVar<danet::RoundScore>::SpaceHandler::TimeState>>(gen, "danet_RoundScore_ts_vector");
  ...
  bind_readonly_vector<dag::Vector<danet::ReflectionVar<danet::dummyForPlayerStat>::SpaceHandler::TimeState>>(gen, "danet_dummyForPlayerStat_ts_vector");
  ...
  bind_readonly_vector<dag::Vector<danet::ReflectionVar<danet::dummyForFootballStat>::SpaceHandler::TimeState>>(gen, "danet_dummyForFootballStat_ts_vector");
  ...
  .def_property_readonly("history", [](danet::ReflectionVar<danet::dummyForFootballStat> &self){return &self.get_history();}, py::return_value_policy::reference_internal);


  //danet::ReflectionVar<Point3> bindings
  py::class_<danet::ReflectionVar<Point3>::SpaceHandler::TimeState>(gen, "Point3_ts")
  .def_readonly("time_ms", &danet::ReflectionVar<Point3>::SpaceHandler::TimeState::time_ms)
  .def_readonly("value", &danet::ReflectionVar<Point3>::SpaceHandler::TimeState::data);

  bind_readonly_vector<dag::Vector<danet::ReflectionVar<Point3>::SpaceHandler::TimeState>>(gen, "Point3_ts_vector");

  py::class_<danet::ReflectionVar<Point3>>(gen, "Point3_var")
  .def_readonly("data", &danet::ReflectionVar<Point3>::data)
  .def_property_readonly("history", [](danet::ReflectionVar<Point3> &self){return &self.get_history();}, py::return_value_policy::reference_internal);
