...
void include_types_0(py::module &gen) {
  ...
  bind_readonly_vector<dag::Vector<danet::ReflectionVar<danet::Crew>::SpaceHandler::TimeState>>(gen,
                                                                                                "danet_Crew_ts_vector");
  ...
  .def_readonly("data", &danet::ReflectionVar<bool>::data)
    .def_property_readonly(
      "history", [](danet::ReflectionVar<bool> &self) { return &self.get_history(); },
