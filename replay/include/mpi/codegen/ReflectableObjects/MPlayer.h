...
public:
  ...
  danet::ReflectionVar<float> timeToRespawn{"timeToRespawn", &timeToRespawnInCoop, 22};
  danet::ReflectionVar<float> timeToRespawnInCoop{"timeToRespawnInCoop", &forcedRespawn, 23};
  danet::ReflectionVar<bool> forcedRespawn{"forcedRespawn", &timeToKick, 24};
  danet::ReflectionVar<float> timeToKick{"timeToKick", &guiState, 25};
