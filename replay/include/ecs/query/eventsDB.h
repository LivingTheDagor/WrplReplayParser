...
namespace ecs {
  ...
  class EventsDB {
    ...
    enum { EVENT_SIZE, EVENT_FLAGS, EVENT_TYPE, EVENT_NAME };
    ...
    bool registerEvent(event_type_t type, event_size_t sz, event_flags_t flag, const char *name, destroy_event *d,
                       move_out_event *m);
